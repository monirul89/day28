                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b " data-id="1"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="2"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of1.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="3"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of2.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="4"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of3.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="5"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of4.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="6"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of5.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="7"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of6.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="8"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of7.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="9"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of8.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="10"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of9.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="11"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of10.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="12"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of11.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="13"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of12.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="14"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of13.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="15"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of14.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="16"
                                                    ...
                                                    data-quantity="1" data-image="{{ asset('/')}}front/images/of15.png">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <a href="kitchen.html"> <img class="first-slide" src="{{ asset('/')}}front/images/ba.jpg"
                                             alt="First slide"></a>

            </div>
            <div class="item">
                <a href="care.html"> <img class="second-slide " src="{{ asset('/')}}front/images/ba1.jpg"
                                          alt="Second slide"></a>

            </div>
            <div class="item">
                <a href="hold.html"><img class="third-slide " src="{{ asset('/')}}front/images/ba2.jpg"
                                         alt="Third slide"></a>
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add add-2">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1"
                                        ...
                                        data-image="{{ asset('/')}}front/images/of16.png">Add to Cart
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1"
                                        ...
                                        data-image="{{ asset('/')}}front/images/of17.png">Add to Cart
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1"
                                        ...
                                        data-image="{{ asset('/')}}front/images/of18.png">Add to Cart
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1"
                                        ...
                                        data-image="{{ asset('/')}}front/images/of19.png">Add to Cart
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-m">
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1"
                                        data-summary="summary 1" data-price="6.00" data-quantity="1"
                                        data-image="{{ asset('/')}}front/images/of20.png">Add to Cart
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-m">
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1"
                                        data-summary="summary 1" data-price="4.50" data-quantity="1"
                                        data-image="{{ asset('/')}}front/images/of21.png">Add to Cart
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-m">
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1"
                                        data-summary="summary 1" data-price="3.50" data-quantity="1"
                                        data-image="{{ asset('/')}}front/images/of22.png">Add to Cart
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-m">
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1"
                                        data-summary="summary 1" data-price="0.80" data-quantity="1"
                                        data-image="{{ asset('/')}}front/images/of23.png">Add to Cart
                                </button>
                            </div>
                        </div>
                    </div>
